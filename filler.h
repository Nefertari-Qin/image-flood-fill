...
namespace filler
{
    ...
    bool isInsideIMG(PNG& img, int x, int y);
    
    bool isWithinTolerance(PNG& img, HSLAPixel & ctr, int i, int j, double tol);

    void addPixelIfUnvisited(PNG& img, int x, int y, HSLAPixel & ctr, 
